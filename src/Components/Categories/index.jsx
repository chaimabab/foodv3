...
},
{
  ...
  const handleData =  () =>{
    axios.get("http://192.168.1.15/admin/api/categories")
    .then((response) => {
  ...
  const handleProdsByCat =  (id) =>{
    axios.get(`http://192.168.1.15/admin/api/categories/products/${id}`)
    .then((response) => {
    ...
    <View style={styles.Categories}> 
      ...
      <View style={styles.cat}>
        <AntDesign
          ...
          />
        {cats? 
          <ListCategories setCategory={setCategory} cats={cats}  /> 
          :""  
      }
      </View>
